...
public class UploadVenuePhotosTask
    extends AsyncTask<UploadVenuePhotosTask.VenueAddPhotoRequest, Void, Void> {
  ...
  private NotificationCompat.Builder notificationBuilder =
      new NotificationCompat.Builder(AppController.context);
  ...
  protected Void doInBackground(VenueAddPhotoRequest... venueAddPhotoRequests) {
    ...
    for (File file : files) UserApi.uploadPhoto(file, venueSlug);
    return null;
  }
  ...
  protected void onPreExecute() {
    ...
    notificationBuilder.setContentTitle(
        AppController.context.getResources().getString(R.string.photo_upload))
        .setSmallIcon(R.drawable.ic_stat_ashojash_logo_final)
        .setAutoCancel(false)
        .setOngoing(true)
  ...
  protected void onPostExecute(Void aVoid) {
    ...
    notificationBuilder.setContentTitle(
        AppController.context.getResources().getString(R.string.finished))
        .setSmallIcon(R.drawable.ic_stat_ashojash_logo_final)
        .setOngoing(false)
        .setProgress(0, 0, false)
        .setSmallIcon(R.drawable.ic_stat_ashojash_logo_final)
        .setContentText(
            AppController.context.getResources().getString(R.string.uploading_photos_finished));
    if (filesCount == 1) {
      notificationBuilder.setContentText(
          AppController.context.getResources().getString(R.string.uploading_photo_finished));
    }
    notificationManager.notify(venuePhotoNotificationId, notificationBuilder.build());
  }
