...
public class VenueBasicMenuAdapter extends RecyclerView.Adapter<VenueBasicMenuAdapter.ViewHolder> {
    private Context context;
    List<StructMenu> structMenuList;
    private Intent intent;

    public VenueBasicMenuAdapter(List<StructMenu> structReviewList, Context context, Intent intent) {
        super();
