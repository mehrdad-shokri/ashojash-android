...
public class EmailRegisterFragment extends Fragment {
  ...
  public void onEvent(OnApiResponseErrorEvent error) {
    if (error.object instanceof UserApiEvents.onUserRegistered) {
      dismissProgressDialog();
      new AshojashSnackbar.AshojashSnackbarBuilder(
          getActivity().findViewById(R.id.rootView)).message(R.string.error_retrieving_data)
  ...
  private void registerUser() {
    ...
    if (validateInputs()) {
      progressDialog =
          ProgressDialog.show(getActivity(), null, getResources().getString(R.string.registering),
              true, false);
  ...
  private void onResponseUpdateView(boolean isGoogleEmail) {
    ...
    if (isGoogleEmail) {
      ...
      verifyEmailDialog = dialogBuilder.create();
      verifyEmailDialog.show();
      verifyEmailDialog.findViewById(R.id.btnContinueInBrowser)
          .setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
              Intent browserIntent =
                  new Intent(Intent.ACTION_VIEW, Uri.parse("http://accounts.google.com/"));
              startActivity(browserIntent);
              ViewPager viewPager =
                  (ViewPager) getActivity().findViewById(R.id.viewpagerProfileActivity);
    ...
    verifyEmailDialog.findViewById(R.id.btnVerifyEmail)
        .setOnClickListener(new View.OnClickListener() {
          @Override
          public void onClick(View view) {
            verifyEmailDialog.dismiss();
  ...
  private void setupViews() {
    usernameWrapper =
        (TextInputLayout) getView().findViewById(R.id.wrapperUsernameFragmentEmailRegister);
    passwordWrapper =
        (TextInputLayout) getView().findViewById(R.id.wrapperPasswordFragmentEmailRegister);
