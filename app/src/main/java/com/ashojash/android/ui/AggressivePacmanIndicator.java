...
public class AggressivePacmanIndicator extends Indicator {
  ...
  @Override public ArrayList<ValueAnimator> onCreateAnimators() {
    ...
    final int PACMAN_DURATION = 550;
    translationAnim.setDuration(PACMAN_DURATION);
    ...
    alphaAnim.setDuration(PACMAN_DURATION);
    ...
    rotateAnim1.setDuration(PACMAN_DURATION);
    ...
    rotateAnim2.setDuration(PACMAN_DURATION);
