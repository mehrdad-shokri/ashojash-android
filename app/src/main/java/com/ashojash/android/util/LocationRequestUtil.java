...
public class LocationRequestUtil implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
            ...
            public void onResult(LocationSettingsResult result) {
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        BusProvider.getInstance().post(new LocationEvents.OnLocationServiceNotAvailable(status));
                        break;
